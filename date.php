...
echo "<br> time() : ", time(), "&nbsp&nbsp&nbsp It Print Total Second of 01/01/1970 to NOW.";

echo "<br> date('d-m-y H:i:sA') : ", date('d-m-y H:i:sA');
echo "<br>";

// exit;

echo "<br> Testing", " Other data <br>";

echo $custDate = "2002-07-28";
echo "<br> strtotime : " . strtotime($custDate);
echo "<br>";

// exit;

echo "<br> strtotime with data() and structure : ";
echo "<br>". date("D-m-Y", strtotime($custDate));
echo "<br>". date("l-m-Y", strtotime($custDate));
echo "<br>". date("j-m-Y", strtotime($custDate));
echo "<br><br>";

// exit;

echo "date('d-m-y l H:i:s') : ". date('d-m-y l H:i:s');
