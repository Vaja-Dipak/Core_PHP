...
<head>
	...
	<meta charset="UTF-8" />
	<meta name="keywords"
		content="Online Resume Services Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	<script>
	...
	<!-- Custom-Files -->
	<link rel="stylesheet" href="<?php echo $this->assetsurl; ?>css/bootstrap.css">
	<!-- Bootstrap-Core-CSS -->
	<link rel="stylesheet" href="<?php echo $this->assetsurl; ?>css/animation-aos.css">
	<link href='<?php echo $this->assetsurl; ?>css/aos.css' rel='stylesheet prefetch' type="text/css" media="all" />
	<!-- animation css -->
	<link rel="stylesheet" href="<?php echo $this->assetsurl; ?>css/style.css" type="text/css" media="all" />
	<!-- Style-CSS -->
	<link rel="stylesheet" href="<?php echo $this->assetsurl; ?>css/all.min.css">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-lg-auto text-lg-right text-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu text-lg-left text-center" aria-labelledby="navbarDropdown">
								<a class="dropdown-item scr" href="registration">Registration</a>
								<a class="dropdown-item scr" href="login" title="">Login</a>
							</div>
						</li>
					</ul>
				</div>
