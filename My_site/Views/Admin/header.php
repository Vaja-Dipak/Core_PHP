...
<section>
  ...
  <!-- if logo is image enable this -->
    ...
    <div class="logo-icon text-center">
      <a href="dashboard" title="logo"><img src="<?php echo $this->assetsurl; ?>admin_assets/images/logo.png" alt="logo-icon"> </a>
    </div>
    <!-- //logo end -->
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->assetsurl; ?>admin_assets/images/avatar1.jpg" alt=""></div>
                  ...
                  <li class="odd"><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->assetsurl; ?>admin_assets/images/avatar2.jpg" alt=""></div>
                      <div class="notification_desc">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->assetsurl; ?>admin_assets/images/avatar3.jpg" alt=""></div>
                      <div class="notification_desc">
              ...
              <li class="dropdown profile_details_drop">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3" aria-haspopup="true"
                  ...
                  <div class="profile_img">
                    <img src="<?php echo $this->assetsurl; ?>admin_assets/images/profileimg.jpg" class="rounded-circle" alt="" />
