...
<section>
  ...
  <!-- if logo is image enable this -->
    ...
    <div class="logo-icon text-center">
      <a href="index.html" title="logo"><img src="<?php echo $this->assetsurl; ?>/images/logo.png" alt="logo-icon"> </a>
    </div>
    <!-- //logo end -->
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->assetsurl; ?>/images/avatar1.jpg" alt=""></div>
                  ...
                  <li class="odd"><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->assetsurl; ?>/images/avatar2.jpg" alt=""></div>
                      <div class="notification_desc">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo $this->assetsurl; ?>/images/avatar3.jpg" alt=""></div>
                      <div class="notification_desc">
              ...
              <li class="dropdown profile_details_drop">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3" aria-haspopup="true"
                  ...
                  <div class="profile_img">
                    <img src="<?php echo $this->assetsurl; ?>/images/profileimg.jpg" class="rounded-circle" alt="" />
...
<script src="<?php echo $this->assetsurl; ?>/js/jquery-3.3.1.min.js"></script>
<script src="<?php echo $this->assetsurl; ?>/js/jquery-1.10.2.min.js"></script>

<!-- chart js -->
<script src="<?php echo $this->assetsurl; ?>/js/Chart.min.js"></script>
<script src="<?php echo $this->assetsurl; ?>/js/utils.js"></script>
<!-- //chart js -->

<!-- Different scripts of charts.  Ex.Barchart, Linechart -->
<script src="<?php echo $this->assetsurl; ?>/js/bar.js"></script>
<script src="<?php echo $this->assetsurl; ?>/js/linechart.js"></script>
<!-- //Different scripts of charts.  Ex.Barchart, Linechart -->


<script src="<?php echo $this->assetsurl; ?>/js/jquery.nicescroll.js"></script>
<script src="<?php echo $this->assetsurl; ?>/js/scripts.js"></script>
...
<!-- disable body scroll when navbar is in active -->
 ...
 <!-- loading-gif Js -->
 <script src="<?php echo $this->assetsurl; ?>/js/modernizr.js"></script>
 <script>
